from operator_pools.generalized_fermionic_pool import get_spin_considered_uccsd_anti_hermitian, get_generalized_fermionic_pool, get_tapered_fermion_uccsd_anti_hermitian
...
def get_generator_pool(pool_type, n_site, n_elec, tapered_sites=[]):
    ...
    if pool_type == 'generalized_fermionic':
        return get_generalized_fermionic_pool(n_site, n_elec)
