#!/usr/bin/env python3
"""
Minimal ADAPT-VQE Test for LiH
This version tests each component individually to isolate memory issues.
"""
...
print("Starting minimal ADAPT-VQE test")
...
try:
    ...
    from src.pools import QE  # Use QE instead of SD
    ...
    # Step 6: Create pool
    print("\n6. Creating pool...")
    pool = QE(molecule)  # Use QE (smaller than SD)
